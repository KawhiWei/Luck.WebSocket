...
namespace Luck.WebSocket.Server
{
    ...
    public class MvcChannelHandler : IWebSocketHandler
    {
        ...
        /// </summary>
        public static ConcurrentDictionary<string, System.Net.WebSockets.WebSocket> Clients { get; set; } = new ConcurrentDictionary<string, System.Net.WebSockets.WebSocket>();
        /// <summary>
        /// Http请求上下文
        /// </summary>
        ...
        public async Task ConnectionEntry(HttpContext context, ILogger<WebSocketRouteMiddleware> logger, WebSocketRouteOption webSocketRouteOption)
        {
            ...
            System.Net.WebSockets.WebSocket webSocketCloseInst = null;
            try
            {
        ...
        /// <returns></returns>
        private async Task MvcForward(HttpContext context, System.Net.WebSockets.WebSocket webSocket)
        {
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        private async Task MvcTextForward(WebSocketReceiveResult result, byte[] buffer, System.Net.WebSockets.WebSocket webSocket, HttpContext context)
        {
        ...
        /// <returns></returns>
        private async Task MvcTextForwardSendData(WebSocketReceiveResult result, System.Net.WebSockets.WebSocket webSocket, HttpContext context, StringBuilder json, long requsetTicks)
        {
            try
            {
        ...
        /// <param name="buffer"></param>
        /// <returns></returns>
        private async Task MvcBinaryForward(HttpContext context, System.Net.WebSockets.WebSocket webSocket, WebSocketReceiveResult result, byte[] buffer)
        {
        ...
        /// <returns></returns>
        public static async Task<MvcResponseScheme> MvcDistributeAsync(WebSocketRouteOption webSocketOptions, HttpContext context, System.Net.WebSockets.WebSocket webSocket, MvcRequestScheme request, ILogger<WebSocketRouteMiddleware> logger)
        {
            long requestTime = DateTime.Now.Ticks;
        ...
        /// <param name="webSocketOptions"></param>
        /// <param name="logger"></param>
        private async Task MvcChannel_OnDisConnected(HttpContext context, System.Net.WebSockets.WebSocket webSocket, WebSocketRouteOption webSocketOptions, ILogger<WebSocketRouteMiddleware> logger)
        {
