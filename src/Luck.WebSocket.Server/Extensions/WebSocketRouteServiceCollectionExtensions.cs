...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class WebSocketRouteServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddWebSocketConfigRouterEndpoint(this IServiceCollection services, Action<WebSocketRouteOption> action)
        {
            if (services == null)
            {
            ...
            {
                webSocketRouteOption.WatchAssemblyContext = new WatchAssemblyContext();
            }
            #region 计算出所有的端点路由 
            //端点路由集合
